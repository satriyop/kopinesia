...
<head>
  ...
  <title>Kopinesia | Point of Sales</title>
...
|---------------------------------------------------------|
-->
<body class="hold-transition skin-black layout-boxed">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><b>Ko</b>Pi</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Kopi</b>nesia</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="images/coffee.png" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="images/coffee.png" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Auth::user()->name }}
                  <small>Barista since Nov. 2018</small>
                </p>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        @yield('title')
        <small>Coffee Shop Point of Sales</small>
      </h1>
      <ol class="breadcrumb">
        @section('breadcrumb')
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">EnterKode</a>.</strong> All rights reserved.
  </footer>
...
<!-- DataTables JS harus urut dari jQuery dulu baru Bootstrap js nya -->
